# cruise-explorer (formerly datacheck) — cross-dataset observation explorer.
#
...
# so the app's pills match calcofi.io/db-schema exactly. fall back to a local set
...
fetch_dataset_pal <- function() {
  ...
  tryCatch({
    ...
    message("cruise-explorer: using fallback palette (", conditionMessage(e), ")")
